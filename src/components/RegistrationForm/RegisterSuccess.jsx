  ...
  return (
    <section className="sectionContainer">
      <div className="container">
        ...
        <p style={{color:"var(--text-color)",fontSize:"18px",fontWeight:"500"}}>Please process the payment of{" "}
        <span style={{ color: "red", fontWeight: "500" }}>Rs. 3000</span> for
        Lifetime Membership of SJSAA.</p>
        <div className="row row-gap-4">
          <div className="col-lg-6">
            <div className="paymentContainer">
              ...
              <h5>After making the payment, send the receipt/copy/pic of payment to our E-Mail ID : sjsaadlwvns@gmail.com</h5>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="paymentContainer">
